...
def save_order():
    ...
    start_date_str=order_data.get("start_date") # 预定的起始时间 2019-03-19
    ...
    # 日期格式检测
    try:
        # 将请求的时间参数字符串转换为datetime类型2019-03-19 00:00:00
...
def get_user_orders():
    ...
    # 用户的身份，用户想要查询作为房客预定别人房子的订单，还是想要作为房东查查别人预定自己房子的订单
